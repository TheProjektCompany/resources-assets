!function (t, e) {
  ...
  t.PipsMode = void 0, (e = t.PipsMode || (t.PipsMode = {})).Range = "range", e.Steps = "steps", e.Positions = "positions", e.Count = "count", e.Values = "values", t.PipsType = void 0, (r = t.PipsType || (t.PipsType = {}))[r.None = -1] = "None", r[r.NoValue = 0] = "NoValue", r[r.LargeValue = 1] = "LargeValue", r[r.SmallValue = 2] = "SmallValue";
  var x = function () {
      function t(t, e, r) {
        var n;
      ...
      return t.prototype.getDistance = function (t) {
        for (var e = [], r = 0; r < this.xNumSteps.length - 1; r++) e[r] = g(this.xVal, t, r);
        return e;
  ...
  function R(t, e) {
    if (!1 !== e) if (!0 === e || n(e)) {
      ...
      if ((e = c(e)).length !== t.handles) throw new Error("noUiSlider: must pass a formatter for all handles.");
  ...
  function $(t) {
    ...
    t.format && !t.ariaFormat && (t.ariaFormat = t.format), Object.keys(r).forEach(function (i) {
      if (o(t[i]) || void 0 !== n[i]) r[i].t(e, o(t[i]) ? t[i] : n[i]);else if (r[i].r) throw new Error("noUiSlider: '" + i + "' is required.");
    }), e.pips = t.pips;
  ...
  function G(e, r, n) {
    var a,
      ...
      k = {},
      M = e.ownerDocument,
      U = r.documentElement || M.documentElement,
      D = M.body,
      O = "rtl" === M.dir || 1 === r.ort ? 0 : 100;
    function L(t, e) {
      var r = M.createElement("div");
      return e && f(r, e), t.appendChild(r), r;
    }
    function T(t, e) {
      var n = L(t, r.cssClasses.origin),
        i = L(n, r.cssClasses.handle);
      if (L(i, r.cssClasses.touchArea), i.setAttribute("data-handle", String(e)), r.keyboardSupport && (i.setAttribute("tabindex", "0"), i.addEventListener("keydown", function (t) {
        return function (t, e) {
          if (H() || F(e)) return !1;
          var n = ["Left", "Right"],
            i = ["Down", "Up"],
          ...
          if (t.preventDefault(), f || p) {
            var m = p ? 0 : 1,
              g = gt(e)[m];
            if (null === g) return !1;
            !1 === g && (g = P.getDefaultStep(N[e], p, r.keyboardDefaultStep)), g *= c || u ? r.keyboardPageMultiplier : r.keyboardMultiplier, g = Math.max(g, 1e-7), g *= p ? -1 : 1, a = C[e] + g;
          } else a = h ? r.spectrum.xVal[r.spectrum.xVal.length - 1] : r.spectrum.xVal[0];
          return pt(e, P.toStepping(a), !0, !0), ot("slide", e), ot("update", e), ot("change", e), ot("set", e), !1;
        }(t, e);
      ...
      return i.setAttribute("role", "slider"), i.setAttribute("aria-orientation", r.ort ? "vertical" : "horizontal"), 0 === e ? f(i, r.cssClasses.handleLower) : e === r.handles - 1 && f(i, r.cssClasses.handleUpper), n.handle = i, n;
    }
    function j(t, e) {
      return !!e && L(t, r.cssClasses.connect);
    }
    function z(t, e) {
      return !(!r.tooltips || !r.tooltips[e]) && L(t.firstChild, r.cssClasses.tooltip);
    }
    function H() {
    ...
    function _() {
      R(), v = p.map(z), nt("update" + E.tooltips, function (t, e, n) {
        if (v && r.tooltips && !1 !== v[e]) {
          var i = t[e];
          !0 !== r.tooltips[e] && (i = r.tooltips[e].to(n[e])), v[e].innerHTML = i;
        }
      });
    }
    function B(t, e) {
    ...
    function q(e) {
      var r,
        n = function (e) {
          if (e.mode === t.PipsMode.Range || e.mode === t.PipsMode.Steps) return P.xVal;
          if (e.mode === t.PipsMode.Count) {
            ...
            return i.push(100), B(i, e.stepped);
          }
      ...
      }, {}))[0] !== o && (n.unshift(o), a = !0), n[n.length - 1] !== s && (n.push(s), l = !0), n.forEach(function (r, o) {
        var s,
          c,
          p,
          f,
          ...
          S = r,
          x = n[o + 1],
          y = e.mode === t.PipsMode.Steps;
        for (y && (s = P.xNumSteps[o]), s || (s = x - S), void 0 === x && (x = S), s = Math.max(s, 1e-7), c = S; c <= x; c = Number((c + s).toFixed(7))) {
          for (g = (d = (f = P.toStepping(c)) - u) / (e.density || 1), b = d / (v = Math.round(g)), p = 1; p <= v; p += 1) i[(h = u + p * b).toFixed(5)] = [P.fromStepping(h), 0];
          m = n.indexOf(c) > -1 ? t.PipsType.LargeValue : y ? t.PipsType.SmallValue : t.PipsType.NoValue, !o && a && c !== x && (m = 0), c === x && l || (i[f.toFixed(5)] = [c, m]), u = f;
        }
      }), i;
    }
    function X(e, n, i) {
      var o,
        ...
        l = ((o = {})[t.PipsType.None] = "", o[t.PipsType.NoValue] = r.cssClasses.valueNormal, o[t.PipsType.LargeValue] = r.cssClasses.valueLarge, o[t.PipsType.SmallValue] = r.cssClasses.valueSub, o),
        u = ((s = {})[t.PipsType.None] = "", s[t.PipsType.NoValue] = r.cssClasses.markerNormal, s[t.PipsType.LargeValue] = r.cssClasses.markerLarge, s[t.PipsType.SmallValue] = r.cssClasses.markerSub, s),
        c = [r.cssClasses.valueHorizontal, r.cssClasses.valueVertical],
        p = [r.cssClasses.markerHorizontal, r.cssClasses.markerVertical];
      function d(t, e) {
        var n = e === r.cssClasses.value,
          i = n ? l : u;
        return e + " " + (n ? c : p)[r.ort] + " " + i[t];
      }
      return f(a, r.cssClasses.pips), f(a, 0 === r.ort ? r.cssClasses.pipsHorizontal : r.cssClasses.pipsVertical), Object.keys(e).forEach(function (o) {
        !function (e, o, s) {
          if ((s = n ? n(o, s) : s) !== t.PipsType.None) {
            var l = L(a, !1);
            l.className = d(s, r.cssClasses.marker), l.style[r.style] = e + "%", s > t.PipsType.NoValue && ((l = L(a, !1)).className = d(s, r.cssClasses.value), l.setAttribute("data-value", String(o)), l.style[r.style] = e + "%", l.innerHTML = String(i.to(o)));
          }
        }(o, e[o][0], e[o][1]);
      }), a;
    }
    ...
    function W() {
      ...
      return 0 === r.ort ? t.width || a[e] : t.height || a[e];
    }
    function G(t, e, n, i) {
      var o = function (o) {
          var s,
            ...
            l = function (t, e, r) {
              ...
              e = e || h(M), (i || o) && (s = t.clientX + e.x, a = t.clientY + e.y);
              return t.pageOffset = e, t.points = [s, a], t.cursor = i || o, t;
            }(o, i.pageOffset, i.target || e);
          return !!l && !(H() && !i.doNotReject) && (s = w, a = r.cssClasses.tap, !((s.classList ? s.classList.contains(a) : new RegExp("\\b" + a + "\\b").test(s.className)) && !i.doNotReject) && !(t === x.start && void 0 !== l.buttons && l.buttons > 1) && (!i.hover || !l.buttons) && (y || l.preventDefault(), l.calcPoint = l.points[r.ort], void n(l, i)));
        },
        s = [];
      return t.split(" ").forEach(function (t) {
        e.addEventListener(t, o, !!y && {
          passive: !0
        }), s.push([t, o]);
      }), s;
    }
    function J(t) {
      var e,
        ...
        s,
        l,
        c = 100 * (t - (e = a, n = r.ort, i = e.getBoundingClientRect(), o = e.ownerDocument, s = o.documentElement, l = h(o), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (l.x = 0), n ? i.top + l.y - s.clientTop : i.left + l.x - s.clientLeft)) / W();
      return c = u(c), r.dir ? 100 - c : c;
    }
    function K(t, e) {
    ...
    function Z(t, e) {
      e.handle && (d(e.handle, r.cssClasses.active), A -= 1), e.listeners.forEach(function (t) {
        U.removeEventListener(t[0], t[1]);
      }), 0 === A && (d(w, r.cssClasses.drag), ct(), t.cursor && (D.style.cursor = "", D.removeEventListener("selectstart", s))), r.events.smoothSteps && (e.handleNumbers.forEach(function (t) {
        pt(t, N[t], !0, !0, !1, !1);
    ...
    function tt(t, e) {
      if (!e.handleNumbers.some(F)) {
        var n;
        if (1 === e.handleNumbers.length) n = p[e.handleNumbers[0]].children[0], A += 1, f(n, r.cssClasses.active);
        t.stopPropagation();
        var i = [],
          o = G(x.move, U, Q, {
            target: t.target,
        ...
        i.push.apply(i, o.concat(a, l)), t.cursor && (D.style.cursor = getComputedStyle(t.target).cursor, p.length > 1 && f(w, r.cssClasses.drag), D.addEventListener("selectstart", s, !1)), e.handleNumbers.forEach(function (t) {
          ot("start", t);
        });
      }
    }
    function et(t) {
      ...
      !1 !== n && (r.events.snap || l(w, r.cssClasses.tap, r.animationDuration), pt(n, e, !0, !0), ct(), ot("slide", n, !0), ot("update", n, !0), r.events.snap ? tt(t, {
        handleNumbers: [n]
      }) : (ot("change", n, !0), ot("set", n, !0)));
    }
    function rt(t) {
      var e = J(t.calcPoint),
        r = P.getStep(e),
    ...
    function nt(t, e) {
      k[t] = k[t] || [], k[t].push(e), "update" === t.split(".")[0] && p.forEach(function (t, e) {
        ot("update", e);
      });
    }
    function it(t) {
    ...
    function ct() {
      V.forEach(function (t) {
        var e = N[t] > 50 ? -1 : 1,
          r = 3 + (p.length + e * t);
        p[t].style.zIndex = String(r);
      });
    }
    function pt(t, e, n, i, o, s) {
      return o || (e = st(N, t, e, n, i, !1, s)), !1 !== e && (function (t, e) {
        N[t] = e, C[t] = P.fromStepping(e);
        var n = "translate(" + at(ut(e, 0) - O + "%", "0") + ")";
        p[t].style[r.transformRule] = n, ft(t), ft(t + 1);
      }(t, e), !0);
    }
    function ft(t) {
      if (m[t]) {
        var e = 0,
          n = 100;
        0 !== t && (e = N[t - 1]), t !== m.length - 1 && (n = N[t]);
        var i = n - e,
          o = "translate(" + at(ut(e, i) + "%", "0") + ")",
          s = "scale(" + at(i / 100, "1") + ")";
        m[t].style[r.transformRule] = o + " " + s;
      }
    }
    function dt(t, e) {
      return null === t || !1 === t || void 0 === t ? N[e] : ("number" == typeof t && (t = String(t)), !1 !== (t = r.format.from(t)) && (t = P.toStepping(t)), !1 === t || isNaN(t) ? N[e] : t);
    }
    function ht(t, e, n) {
      var i = c(t),
        o = void 0 === N[0];
      e = void 0 === e || e, r.animate && !o && l(w, r.cssClasses.tap, r.animationDuration), V.forEach(function (t) {
        pt(t, dt(i[t], t), !0, !1, n);
      });
      var s = 1 === V.length ? 0 : 1;
      if (o && P.hasNoSize() && (n = !0, N[0] = 0, V.length > 1)) {
        var a = 100 / (V.length - 1);
        V.forEach(function (t) {
          N[t] = t * a;
        });
      }
      for (; s < V.length; ++s) V.forEach(function (t) {
        pt(t, N[t], !0, !0, n);
      });
      ct(), V.forEach(function (t) {
        ot("update", t), null !== i[t] && e && ot("set", t);
      });
    }
    function mt(t) {
      if (void 0 === t && (t = !1), t) return 1 === C.length ? C[0] : C.slice(0);
    ...
    function gt(t) {
      ...
      !1 !== o && i + o > n.stepAfter.startValue && (o = n.stepAfter.startValue - i), s = i > n.thisStep.startValue ? n.thisStep.step : !1 !== n.stepBefore.step && i - n.stepBefore.highestStep, 100 === e ? o = null : 0 === e && (s = null);
      var a = P.countStepDecimals();
      return null !== o && !1 !== o && (o = Number(o.toFixed(a))), null !== s && !1 !== s && (s = Number(s.toFixed(a))), [s, o];
    }
    f(b = w, r.cssClasses.target), 0 === r.dir ? f(b, r.cssClasses.ltr) : f(b, r.cssClasses.rtl), 0 === r.ort ? f(b, r.cssClasses.horizontal) : f(b, r.cssClasses.vertical), f(b, "rtl" === getComputedStyle(b).direction ? r.cssClasses.textDirectionRtl : r.cssClasses.textDirectionLtr), a = L(b, r.cssClasses.base), function (t, e) {
      var n = L(e, r.cssClasses.connects);
      p = [], (m = []).push(j(n, t[0]));
      for (var i = 0; i < r.handles; i++) p.push(T(e, i)), V[i] = i, m.push(j(n, t[i + 1]));
    }(r.connect, a), (S = r.events).fixed || p.forEach(function (t, e) {
      G(x.start, t.children[0], tt, {
        handleNumbers: [e]
      });
    }), S.tap && G(x.start, a, et, {}), S.hover && G(x.move, a, rt, {
      hover: !0
    }), S.drag && m.forEach(function (t, e) {
      if (!1 !== t && 0 !== e && e !== m.length - 1) {
        var n = p[e - 1],
          ...
          s = [n, i],
          a = [e - 1, e];
        f(t, r.cssClasses.draggable), S.fixed && (o.push(n.children[0]), o.push(i.children[0])), S.dragAll && (s = p, a = V), o.forEach(function (e) {
          G(x.start, e, tt, {
            handles: s,
            handleNumbers: a,
            connect: t
    ...
    }), ht(r.start), r.pips && I(r.pips), r.tooltips && _(), it("update" + E.aria), nt("update" + E.aria, function (t, e, n, i, o) {
      V.forEach(function (t) {
        var e = p[t],
          i = st(N, t, 0, !0, !0, !0),
          s = st(N, t, 100, !0, !0, !0),
    ...
    var vt = {
      destroy: function () {
        for (it(E.aria), it(E.tooltips), Object.keys(r.cssClasses).forEach(function (t) {
          d(w, r.cssClasses[t]);
      ...
      setHandle: function (t, e, r, n) {
        ...
        pt(t, dt(e, t), !0, !0, n), ot("update", t), r && ot("set", t);
      },
      reset: function (t) {
        ht(r.start, t);
      },
      disable: function (t) {
        null != t ? (p[t].setAttribute("disabled", ""), p[t].handle.removeAttribute("tabindex")) : (w.setAttribute("disabled", ""), p.forEach(function (t) {
          t.handle.removeAttribute("tabindex");
        }));
      },
      enable: function (t) {
        null != t ? (p[t].removeAttribute("disabled"), p[t].handle.setAttribute("tabindex", "0")) : (w.removeAttribute("disabled"), p.forEach(function (t) {
      ...
      updateOptions: function (t, e) {
        ...
        s.forEach(function (e) {
          void 0 !== t[e] && (r[e] = a[e]);
        }), P = a.spectrum, r.margin = a.margin, r.limit = a.limit, r.padding = a.padding, r.pips ? I(r.pips) : Y(), r.tooltips ? _() : R(), N = [], ht(o(t.start) ? t.start : i, e);
      },
      target: w,
      removePips: Y,
      removeTooltips: R,
  ...
  t.create = J, t.cssClasses = w, t.default = K, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});